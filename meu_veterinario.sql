...
--
-- Host: 127.0.0.1
-- Generation Time: 02-Abr-2018 às 06:59
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `AdicionarUsuario` (IN `id_pessoa` INT, IN `nome` VARCHAR(45), IN `data_nasc` DATE, IN `sexo` VARCHAR(45), IN `telefone` INT, IN `usuario` VARCHAR(45), IN `senha` VARCHAR(45), IN `endereco` VARCHAR(50), IN `cidade` VARCHAR(45), IN `estado` VARCHAR(45))  BEGIN
	INSERT INTO `meu_veterinario`.`tb_pessoa`
(`id_pessoa`,`nome`,`data_nasc`,`sexo`,`telefone`,`usuario`,`senha`,
`endereco`,`cidade`,`estado`)
VALUES
(id_pessoa,nome,data_nasc,sexo,telefone,usuario,senha,endereco,cidade,estado);	
END$$
...
INSERT INTO `estado` (`id_estado`, `nome`, `uf`, `pais`) VALUES
(1, 'Acre', 'AC', 1),
(2, 'Alagoas', 'AL', 1),
(3, 'Amazonas', 'AM', 1),
(4, 'Amapá', 'AP', 1),
...
CREATE TABLE `tb_atendimento` (
  ...
  `tb_clinica_id_clinica` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tb_pessoa` (`id_pessoa`, `nome`, `data_nasc`, `sexo`, `telefone`, `usuario`, `senha`, `email`, `cidade`, `estado`) VALUES
(1, 'Filipe Freitas', '1997-11-18', 'Feminino', 992891299, 'filipefreitas', '12345', 'filipeflafds@hotmail.com', 'Paraiso do Tocantins', 'TO'),
(2, 'Filipe Freitas', '2018-03-01', 'Feminino', 686868681, 'sdfsdfsdf', '32d9265c2e3703d89c0ba1fdc256ac38', 'fsdfsdfsdf', 'fsdfsdfsdf', 'sdfsdfsdf'),
(3, 'Filipe Freitas', '0000-00-00', 'Feminino', 686868681, 'sdfsdfsdf', '0b4840e576e1de6407c05983877336d1', 'fsdfsdfsdf', 'fsdfsdfsdf', 'sdfsdfsdf'),
(4, 'Filipe Freitas', '2018-03-01', 'Feminino', 686868681, 'sdfsdfsdf', 'c84292ad909bc9d074e54a96bcd97540', 'fsdfsdfsdf', 'fsdfsdfsdf', 'sdfsdfsdf'),
(5, 'Filipe Freitas', '2018-03-01', 'Feminino', 686868681, 'sdfsdfsdf', 'd41d8cd98f00b204e9800998ecf8427e', 'fsdfsdfsdf', 'fsdfsdfsdf', 'sdfsdfsdf'),
(6, 'Filipe Freitas', '2018-03-01', 'Feminino', 686868681, 'sdfsdfsdf', 'd41d8cd98f00b204e9800998ecf8427e', 'fsdfsdfsdf', 'fsdfsdfsdf', 'sdfsdfsdf'),
(7, 'xfgfgf', '2018-04-08', 'Masculino', 24542424, 'fgfg', '13b920adfaf00184fc0d4e5fee6f4551', '', 'fdgdgd', 'fg'),
(8, 'xfgfgf', '2018-04-08', 'Masculino', 24542424, 'fgfg', '13b920adfaf00184fc0d4e5fee6f4551', '', 'fdgdgd', 'fg'),
(9, 'xfgfgf', '2018-04-08', 'Masculino', 24542424, 'fgfg', '343d9040a671c45832ee5381860e2996', '', 'fdgdgd', 'fg'),
(10, 'xfxgxfgx', '2018-04-11', 'Masculino', 4525245, 'ngngn', '9e7c2fcdd8d67cacc5d164bd92a4d499', '4ghnvng@gmai.com', 'ngngn', 'ngv'),
(11, 'Edna', '2018-04-03', 'Feminino', 632584, 'edna', 'f5fa02bc60f633f3b1781a824f5211b5', 'd@gmail.com', 'undefined', '27'),
(12, 'Filipe', '1997-11-18', 'Masculino', 2147483647, 'filipe', 'a5530b58fabf3c5c89189ed6c7a065f5', 'filipe.ifto@gmail.com', 'undefined', '27'),
(13, 'jose', '2018-04-04', 'Masculino', 2147483647, 'josa', '662eaa47199461d01a623884080934ab', 'ff@aa.com', 'undefined', '27'),
(14, 'eeee', '2018-04-10', 'Masculino', 555, 'euu', '1f24fddc6ae4b26ffeed6e9d9a650675', 'ff@aa.com', '1576', '11'),
(15, 'ee', '2018-04-04', 'Masculino', 56285468, '12345', '123', 'filipe.ifto@gmail.com', '2799', '18');
...
CREATE TABLE `tb_resposta` (
  ...
  `tb_duvida_id_duvida` int(11) NOT NULL,
  `tb_pessoa_id_pessoa` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
ALTER TABLE `tb_animal`
  ADD PRIMARY KEY (`id_animal`,`tb_pessoa_id_pessoa`),
  ADD KEY `fk_tb_animal_tb_pessoa` (`tb_pessoa_id_pessoa`);

--
-- Indexes for table `tb_atendimento`
--
ALTER TABLE `tb_atendimento`
  ADD PRIMARY KEY (`id_atendimento`,`tb_clinica_id_clinica`),
  ADD KEY `fk_tb_atendimento_tb_clinica1` (`tb_clinica_id_clinica`);
...
ALTER TABLE `tb_clinica`
  ...
  ADD KEY `fk_cidade_clinica_idx` (`cidade`),
  ADD KEY `fk_estado_clinica_idx` (`estado`);

--
-- Indexes for table `tb_consulta`
--
ALTER TABLE `tb_consulta`
  ADD PRIMARY KEY (`id_consulta`,`tb_clinica_id_clinica`,`tb_animal_id_animal`),
  ADD KEY `fk_tb_consulta_tb_clinica1` (`tb_clinica_id_clinica`),
  ADD KEY `fk_tb_consulta_tb_animal1` (`tb_animal_id_animal`);

--
-- Indexes for table `tb_duvida`
--
ALTER TABLE `tb_duvida`
  ADD PRIMARY KEY (`id_duvida`,`tb_pessoa_id_pessoa`),
  ADD KEY `fk_tb_duvida_tb_pessoa1` (`tb_pessoa_id_pessoa`);
...
ALTER TABLE `tb_resposta`
  ADD PRIMARY KEY (`id_resposta`,`tb_duvida_id_duvida`,`tb_pessoa_id_pessoa`),
  ADD KEY `fk_tb_resposta_tb_duvida1` (`tb_duvida_id_duvida`),
  ADD KEY `fk_tb_resposta_tb_pessoa1` (`tb_pessoa_id_pessoa`);
...
--
-- AUTO_INCREMENT for table `tb_duvida`
--
ALTER TABLE `tb_duvida`
...
--
ALTER TABLE `tb_animal`
  ADD CONSTRAINT `fk_tb_animal_tb_pessoa` FOREIGN KEY (`tb_pessoa_id_pessoa`) REFERENCES `tb_pessoa` (`id_pessoa`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `tb_atendimento`
--
ALTER TABLE `tb_atendimento`
  ADD CONSTRAINT `fk_tb_atendimento_tb_clinica1` FOREIGN KEY (`tb_clinica_id_clinica`) REFERENCES `tb_clinica` (`id_clinica`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `tb_clinica`
--
ALTER TABLE `tb_clinica`
  ADD CONSTRAINT `fk_cidade_clinica` FOREIGN KEY (`cidade`) REFERENCES `cidade` (`id_cidade`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_estado_clinica` FOREIGN KEY (`estado`) REFERENCES `estado` (`id_estado`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `tb_consulta`
--
ALTER TABLE `tb_consulta`
  ADD CONSTRAINT `fk_tb_consulta_tb_animal1` FOREIGN KEY (`tb_animal_id_animal`) REFERENCES `tb_animal` (`id_animal`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_tb_consulta_tb_clinica1` FOREIGN KEY (`tb_clinica_id_clinica`) REFERENCES `tb_clinica` (`id_clinica`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `tb_duvida`
--
ALTER TABLE `tb_duvida`
  ADD CONSTRAINT `fk_tb_duvida_tb_pessoa1` FOREIGN KEY (`tb_pessoa_id_pessoa`) REFERENCES `tb_pessoa` (`id_pessoa`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `tb_resposta`
--
ALTER TABLE `tb_resposta`
  ADD CONSTRAINT `fk_tb_resposta_tb_duvida1` FOREIGN KEY (`tb_duvida_id_duvida`) REFERENCES `tb_duvida` (`id_duvida`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_tb_resposta_tb_pessoa1` FOREIGN KEY (`tb_pessoa_id_pessoa`) REFERENCES `tb_pessoa` (`id_pessoa`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
